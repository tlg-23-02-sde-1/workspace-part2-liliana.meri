...
public class ShoppingCartTest {
    ...
    public void testProductCart() {
        ShoppingCart<Product> cart = new ShoppingCart<>(); // T of: any* Product Type
    ...
    public void testMusicItemCart() {
        ShoppingCart<MusicItem> cart = new ShoppingCart<>(); // only T of: MusicItem
    ...
    public void testMediaPlayerCart() {
        ShoppingCart<MediaPlayer> cart = new ShoppingCart<>(); // only T of: MediaPlayer
